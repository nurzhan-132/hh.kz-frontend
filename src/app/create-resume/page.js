    ...
    return (
        <main>
            ...
            <div className='container p7'>
                ...
                <AutoCompleteTags type="text" label="Ключевые навыки" size="fieldset-md" items={allSkills} onSelect={onSkillsChange}/>
                ...
                <AddLanguage onChange={(lns) => setForeignLanguages(lns)}/>

                <h3>Другая важная информация</h3>
                <SelectEmploymentTypes employmentTypes={allEmploymentTypes}  size="fieldset-md" label="Занятость" onChange={types => setSelectedEmpTypes(types)}/>
